...
function process_node(profile, node, result)
  ...
  -- SKO BUFFS FLOOD MODEL ford=yes is a barrier
  local ford = node:get_value_by_key("ford")
  if "yes" == ford then
    result.barrier = true
  end
...
function process_way(profile, way, result)
  ...
  if "yes" == data.bridge and "yes" == data.flood_prone then
    return
  end
  ...
  local handlers = Sequence {
    ...
    -- disallow flood_prone bridges SKO BUFFS
    WayHandlers.no_flood_prone,
