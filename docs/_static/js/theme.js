        ...
        e.exports.ThemeNav = {
                ...
                enable: function(e) {
                    ...
                    void 0 === e && (e = !0), i.isRunning || (i.isRunning = !0, jQuery(function(n) {
                        i.init(n), e && i.win.on("scroll", function() {
                ...
                init: function(i) {
                    ...
                    this.navBar = i("div.wy-side-scroll:first"), this.win = i(window), i(document).on("click", "[data-toggle='wy-nav-top']", function() {
                        ...
                        expand = i('<span class="toctree-expand"></span>'), expand.on("click", function(n) {
                            var z = e.closest("li");
                            console.log(z);
                            return z.toggleClass("current"), n.stopPropagation(), !1
                        }), e.prepend(expand), expand.click()
                    })
                ...
                reset: function() {
                    ...
                    try {
                        ...
                        0 < i.length && (i.addClass("current"), i.closest("li.toctree-l1").addClass("current"), i.closest("li.toctree-l1").parent().addClass("current"), i.closest("li.toctree-l1").addClass("current"), i.closest("li.toctree-l2").addClass("current"), i.closest("li.toctree-l3").addClass("current"), i.closest("li.toctree-l4").addClass("current"), i[0].scrollIntoView())
                    } catch (o) {
                ...
                toggleCurrent: function(n) {
                    var e = n.closest("li");
                    //e.siblings("li.current").removeClass("current"), e.find("> ul li.current").removeClass("current"), e.toggleClass("current"), e.parents("li").siblings("li").find("li.current").removeClass("current")
                }
...
window.addEventListener("load", function(){
    console.log("sko buffs!");

    document.querySelectorAll(".local-toc>ul>li").forEach(function(el) {
